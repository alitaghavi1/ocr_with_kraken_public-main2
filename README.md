...
## Fine-Tuning for Handwritten Data

To train/fine-tune a model with your own handwritten data, see **[TRAINING_GUIDE.md](TRAINING_GUIDE.md)**.

Quick start:
```bash
# 1. Put your training data in handwritten_training_data/
#    (image + .gt.txt pairs)
